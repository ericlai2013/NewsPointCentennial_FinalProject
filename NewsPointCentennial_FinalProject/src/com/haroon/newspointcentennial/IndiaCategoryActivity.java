...
public class IndiaCategoryActivity extends M_Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.india_category);
		...
		GridView gridview = (GridView) findViewById(R.id.gridview_india);
		gridview.setAdapter(new ImageAdapterIndia(this));
		...
		gridview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View v,
				...
				Toast.makeText(IndiaCategoryActivity.this, "" + position,
	...
	private void initializeDatabase() {
		...
		c = sh.getCategoryForCountry("india");
		while (c.moveToNext()) {
			String caUrl = c.getString(c
					.getColumnIndex(CategoryTable.CATEGORY_URL));
			arrUrl.add(caUrl);
			System.out.println("Category india information: " + caUrl);
